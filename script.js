...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const arrowLeft = document.querySelector(
    '.carousel-arrow-left[data-carousel="story"]',
  );
  const arrowRight = document.querySelector(
    '.carousel-arrow-right[data-carousel="story"]',
  );
  const indicators = document.querySelectorAll(
    '.carousel-indicators[data-carousel="story"] .indicator',
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const arrowLeft = document.querySelector(
    '.carousel-arrow-left[data-carousel="gallery"]',
  );
  const arrowRight = document.querySelector(
    '.carousel-arrow-right[data-carousel="gallery"]',
  );
  const indicators = document.querySelectorAll(
    ".carousel-indicators-gallery .indicator-gallery",
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const carouselIndicators = document.querySelector(
    '.carousel-indicators[data-carousel="story"]',
  );
